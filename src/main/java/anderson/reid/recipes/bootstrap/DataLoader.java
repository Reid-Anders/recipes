package anderson.reid.recipes.bootstrap;

import anderson.reid.recipes.domain.*;
import anderson.reid.recipes.repositories.CategoryRepository;
import anderson.reid.recipes.repositories.RecipeRepository;
import anderson.reid.recipes.repositories.UnitOfMeasureRepository;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
   ...
   public void onApplicationEvent(ContextRefreshedEvent event) {
      log.debug("We are about to load the data");
      recipeRepository.saveAll(getRecipes());
      log.debug("We have just loaded the data");
   }
